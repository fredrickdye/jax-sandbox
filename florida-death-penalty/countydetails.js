...
$.getJSON($('link[rel="deathrowlist"]').attr("href"), function(data) {
    $(data).each(function() { output = "<p class=\"drlist\">" + this.name + ", incarcerated since " + this.received + "<!-- and facing " + this.sentences + " death sentence(s).--></p>";
